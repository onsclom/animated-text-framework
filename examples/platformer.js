...
function getNextBarrelTime() {
    return MIN_BARREL_INTERVAL + Math.random()*(MAX_BARREL_INTERVAL-MIN_BARREL_INTERVAL)
}
...
function update() {
    ...
    print(player.y == player.startY ? playerGrounded : playerJumping, Math.round(player.x), Math.round(player.y))
